...
Deno.serve(async (req: Request) => {
  ...
  const projectServicePath = `/home/deno/project-functions/${service_name}`
  const bundledServicePath = `/home/deno/functions/${service_name}`
  const servicePath = await exists(projectServicePath) ? projectServicePath : bundledServicePath
