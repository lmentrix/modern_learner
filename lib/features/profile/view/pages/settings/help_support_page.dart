      ...
      child: SafeArea(
        child: CustomScrollView(
          ...
          slivers: [
            ...
            SliverPadding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              sliver: SliverToBoxAdapter(child: _sectionLabel('QUICK HELP')),
            ),
            ...
            SliverPadding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              sliver: SliverToBoxAdapter(child: _sectionLabel('CONTACT US')),
            ),
            ...
            SliverPadding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              sliver: SliverToBoxAdapter(child: _sectionLabel('ABOUT')),
            ),
...
const _faqs = [
  _Faq(
    ...
    answer:
        'You can reset your progress for any language by going to Settings > Learning Languages > Select Language > Reset Progress. This action cannot be undone.',
  ...
  _Faq(
    ...
    answer:
        'Yes! Download lessons for offline use by tapping the download icon on any lesson card. Your progress will sync when you reconnect.',
  ...
  _Faq(
    ...
    answer:
        'You can reach our support team through live chat, email at support@modernlearner.app, or visit our community forum for help from other users.',
