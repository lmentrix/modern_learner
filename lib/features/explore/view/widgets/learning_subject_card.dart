...
import 'package:modern_learner_production/features/explore/view/widgets/learning_subject_difficulty_dot.dart';

class LearningSubjectCard extends StatefulWidget {
  const LearningSubjectCard({super.key, required this.subject, this.onTap});
